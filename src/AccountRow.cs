...
internal sealed class AccountRow : Control
{
    ...
    public AccountRow(Account account)
    {
        ...
        _titleFont = new Font(Font.FontFamily, 9f, FontStyle.Bold);
    ...
    {
        var fillColour = ListStyle.OverBackground(CardFillFor(), 226);
    ...
    private void PaintGroupOutline(Graphics g)
    {
        ...
        var groupColour = ListStyle.OverBackground(GroupFillFor(), 200);
