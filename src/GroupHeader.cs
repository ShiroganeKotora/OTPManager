...
internal sealed class GroupHeader : Control
{
    ...
    public GroupHeader(AccountGroup group, int count)
    {
        ...
        _countFont = new Font(Font.FontFamily, Font.Size, FontStyle.Bold);
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        band = ListStyle.OverBackground(band, 216);
        ...
        var size = TextRenderer.MeasureText(g, count, _countFont);
        TextRenderer.DrawText(g, count, _countFont, new Point(right - 10 - size.Width, top + (BaseHeight - size.Height) / 2 + 1),
    ...
    {
        if(disposing) { _nameFont.Dispose(); _countFont.Dispose(); _menu.Dispose(); }
