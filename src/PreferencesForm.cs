...
internal sealed partial class PreferencesForm : Form
{
    ...
    public PreferencesForm(AccountStore store, Action dataChanged, Size listViewport)
    {
        ...
        foreach(var panel in _panels)
        {
            ...
            // The window is a fixed size on purpose. A page holding more than fits scrolls rather
            // than pushing the dialog out of shape. The right-hand padding is where the scrollbar
            // goes - without it the controls run underneath it and look like they overflow.
